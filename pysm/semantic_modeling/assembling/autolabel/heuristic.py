...
def get_gold_semantic_types(gold_sm: Graph):
    stypes = {}
    for n in gold_sm.iter_data_nodes():
        dlink = n.get_first_incoming_link()
        stypes[n.label] = (dlink.get_source_node().label, dlink.label)
    return stypes
